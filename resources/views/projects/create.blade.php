            ...
            <form method="POST" action="/projects">
                ...
                <div class="max-w-6xl mx-auto sm:px-10 lg:px-8">
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg px-5 py-5 flex space-x-5">
                        ...
                        <input class="shadow appearance-none border rounded w-full py-2 px-3 flex-auto text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="Name" type="text" placeholder="Name" name="Name">      
                            @error('Name')
                ...
                <div class="max-w-6xl mx-auto sm:px-10 lg:px-8">
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg px-5 py-5 flex space-x-5">
                        ...
                        <input class="shadow appearance-none border rounded w-full py-2 px-3 flex-auto text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="PKey" type="text" placeholder="Key" name="PKey">
                            @error('PKey')
                                <div class="text-red-500 mt-2 text-sm">
                                    {{ $message }}
                                </div>
